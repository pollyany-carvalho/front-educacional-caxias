...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-percent fa-xl"></i> <span>Cadastro de
						Descontos</span>
				</div>
			</div>
		</section>
		<section class="pt-4">
			<form id="form-user-parceiro" class="card form p-5 col-8 mx-auto">
				<h1 class="text-center mb-5">Cadastrar Descontos</h1>
				...
				<div class="row mb-2">
					...
					<div class="col-md-4">
						...
						<div class="form-control border-0 p-0">
							<input id='ativo' type="checkbox" name="ativo" checked
								data-toggle="toggle" data-onstyle="secondary"
	...
	<script
		src="<%=contextPath%>/resources/assets/js/cadastroDeDescontos.js"></script>
