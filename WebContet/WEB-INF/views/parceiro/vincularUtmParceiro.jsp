...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-3">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-link fa-lg"></i> <span>Vincular
						Parceiro</span>
				</div>
			</div>
		</section>
		<section class="pt-1 mb-4">
			<form id="form-parceiro-utm" class="card form py-3 px-5">
				...
				<div class="row mt-2">
					...
					<div class="col-md-4">
						<label for="utm" class="form-label">UTM:</label> <select required
							id="listaLyceum" class="form-select inputForm" name="utm"
					...
					<div class="col-md-4 d-flex align-items-center">
						<button type="submit" id="btn-submit"
							class="btn btn-add btn-primary btn-register">Adicionar</button>
					</div>
				</div>
			</form>
		</section>

		<section id="card-table" class="pt-4 card card-table px-5 py-5">
			<!-- <div
          class="mt-3 mb-2"
        ...
        >
          ...
          <a
            href="./cadastro-de-parceiros.html"
          ...
          >
			...
			<table
				...
				<caption>Parceiros vinculados</caption>
				<thead>
					<tr>
						<th scope="col" width="10%">Ativo</th>
						<th scope="col">Parceiro</th>
						<th scope="col">UTM</th>
						<th scope="col" width="15%">Ativar/Desativar</th>
					</tr>
				</thead>
	...
	<script src="<%=contextPath%>/resources/assets/js/vincularUtm.js"></script>
	<script
