...
<body>
			...
			<div class="mt-3 mb-2"
				...
				<div class="input-group" style="width: 30%;">
					<input id="inputBusca" type="text" class="form-control inputForm"
						placeholder="Buscar usuário"> <span
						class="input-group-text"><i class="fas fa-search"></i></span>
				</div>
				<a href="cadastroDeUsuarioParceiro"
					class="btn btn-primary btn-lg px-3">Novo
					usuário</a>
			</div>

			<table
				class="table tabela-parceiros table-striped table-bordered mb-0 caption-top mx-auto">
				<caption>Usúarios parceiros cadastrados</caption>
				<thead>
					<tr>
	...
	<script
		src="<%=contextPath%>/resources//assets/js/listarUsersParceiros.js"></script>
	<script
